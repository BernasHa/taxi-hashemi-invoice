...
class PDFService {
  ...
  static Future<Uint8List> generatePDF(InvoiceData invoiceData) async {
    ...
    const int tripsPerPage = 28;          // Folgeseiten: bis zu 28 Fahrten (+ Summary auf letzter)
    ...
    if (singlePageLayout) {
      ...
      // Restliche Fahrten in Seiten à 28 aufteilen
          ...
          children: [
            ...
            pw.Column(
              ...
              children: [
                ...
                pw.SizedBox(height: 2), // Minimal Abstand zum Stamp
            ...
            pw.Expanded(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.SizedBox(height: 6), // Minimal Abstand zum Stamp (Single-Page)
                  if (stamp != null)
                    pw.Container(
                      width: 100,
                      height: 40,
